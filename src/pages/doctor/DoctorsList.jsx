...
import { Phone, Stethoscope, Search, Instagram, Linkedin, Twitter, Facebook, ChevronLeft, ChevronRight, Filter } from "lucide-react";
...
const fakeDoctors = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1594824885935-fbb16723790d?w=400&h=400&fit=crop&crop=face",
    experience: 8,
    rating: 4.7
  },
  {
...
// Separate DoctorCard component to handle hover state
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getSpecialtyColor(doctor.specialty.name)}`}>
...
const DoctorsList = () => {
  ...
  useEffect(() => {
    let filtered = doctors.filter((doctor) => {
      ...
      const specialtyMatch = selectedSpecialty === "All" || doctor.specialty.name === selectedSpecialty;
  ...
  const specialties = ["All", ...new Set(doctors.map(doctor => doctor.specialty.name))];
